...
int main(int argc, char* argv[])
{
  ...
  obj_panel = new GLUI_Rollout(glui_context, "Properties", false );
  ...
  GLUI_Rollout *roll_lights = new GLUI_Rollout(glui_context, "Lights", false );
  ...
  /*** Add another rollout ***/
  GLUI_Rollout *options = new GLUI_Rollout(glui_context, "Options", true );
  ...
  /**** Add listbox ****/
  new GLUI_StaticText( glui_context, "" );
  GLUI_Listbox *list = new GLUI_Listbox( glui_context, "Text:", &curr_string );
  int i;
  for( i=0; i<4; i++ )
  ...
  new GLUI_Button( glui_context, "Disable movement", DISABLE_ID, control_cb );
  new GLUI_Button( glui_context, "Enable movement", ENABLE_ID, control_cb );
  new GLUI_Button( glui_context, "Hide", HIDE_ID, control_cb );
  new GLUI_Button( glui_context, "Show", SHOW_ID, control_cb );
